...
from mlp.external import TCNN_EXISTS, tcnn
...
def create_mlp(
    ...
    if TCNN_EXISTS:
        return _create_mlp_tcnn(in_dim, num_layers, layer_width, out_dim, initialize_last_layer_zeros)
    else:
        return _create_mlp_torch(in_dim, num_layers, layer_width, out_dim, initialize_last_layer_zeros)
